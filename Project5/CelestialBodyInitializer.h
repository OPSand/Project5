...
public:
	...
	double static rho(double r, double avgM, double n);
	double static G(double r0, double avgM, double n);
	double static tCrunch(double r0, double avgM, double n, double Gyls);
};
